 ...
 */
declare const PLANET_KEYS: readonly ["sun", "earth", "moon", "north_node", "south_node", "mercury", "venus", "mars", "jupiter", "saturn", "uranus", "neptune", "pluto"];
type PlanetKey = (typeof PLANET_KEYS)[number];
/** Geocentric ecliptic longitude in degrees [0, 360) for each HD body. */
type BodyLongitudes = Record<PlanetKey, number>;
/**
 ...
 */
type Convention = 'geometric' | 'apparent';
...
declare function norm360(d: number): number;
/** Signed difference (a - b) in degrees, normalized to (-180, 180]. */
declare function signedAngularDiff(a: number, b: number): number;

export { type BodyLongitudes as B, type Convention as C, type EphemerisEngine as E, type PlanetKey as P, PLANET_KEYS as a, norm360 as n, signedAngularDiff as s };
